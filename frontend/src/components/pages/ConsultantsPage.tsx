...
export function ConsultantsPage() {
  ...
  const consultants: Consultant[] = [
    ...
    },
    {
      ...
      experience: "12+ years",
      successRate: "94%",
      photoUrl: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx4fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    ...
    },
    {
      ...
      experience: "10+ years",
      successRate: "98%",
      photoUrl: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-4 text-center">
                    <div>
                      <div className="text-lg font-semibold text-gray-900">{consultant.rating}</div>
                      <div className="text-xs text-gray-500">Rating</div>
                    </div>
                    <div>
                      <div className="text-lg font-semibold text-gray-900">{consultant.experience}</div>
                      <div className="text-xs text-gray-500">Experience</div>
                    </div>
                    <div>
                      <div className="text-lg font-semibold text-emerald-600">{consultant.successRate}</div>
