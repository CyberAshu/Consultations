    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-[95dvw] md:max-w-[78dvw] 2.5xl:max-w-[1300px] mx-auto md:px-4 py-16 md:py-24 flex flex-col justify-center items-center md:items-start md:flex-row md:gap-10">
        <div className="px-[5dvw] md:px-0 transition-all duration-700 ease-out transform w-[95%] md:w-[44%]" style={{opacity: 1, transform: 'translateY(0px)'}}>
          ...
          <h1 className="text-4xl md:text-5xl font-light mb-4" style={{fontFamily: "'Bricolage Grotesque', sans-serif"}}>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-light text-gray-900 mb-6" style={{fontFamily: "'Bricolage Grotesque', sans-serif"}}>
              What We Stand For
            </h3>
            ...
            {[
              ...
              >
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-medium text-gray-900 mb-4" style={{fontFamily: "'Bricolage Grotesque', sans-serif"}}>{pillar.title}</h3>
            ...
            {[
              ...
              >
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-medium text-gray-900 mb-4" style={{fontFamily: "'Bricolage Grotesque', sans-serif"}}>{persona.title}</h3>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h3 className="text-4xl md:text-5xl font-light text-gray-900 mb-8" style={{fontFamily: "'Bricolage Grotesque', sans-serif"}}>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {[
                ...
                <div key={index} className="text-center">
                  ...
                  <h3 className="text-xl font-medium text-gray-900 mb-2" style={{fontFamily: "'Bricolage Grotesque', sans-serif"}}>{promise.title}</h3>
